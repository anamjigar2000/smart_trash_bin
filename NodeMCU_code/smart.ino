...
#define trig_us 5  // Trigger pin for both ultrasonic sensor.
#define echo_us1 4 // Echo pin for 1st ultrasonic sensor.
#define echo_us2 0 // Echo pin for 2nd ultrasonic sensor.
#define motor_pin 13 // D7 or GPIO2 pin for Servo-motor control.
#define RD_pin 14 // Raindrop sensor digital pin
#define IR_pin 12 // IR sensor digital pin
...
char auth[] = "DvWorULtQrunCk1qVSC1r4MD_xgCCoDd";
const char *ssid = "proj"; // WiFi Name (SSID)
const char *pswd = "12345678"; // WiFi Password
const char *host = "https://smarttrashbin.netlify.app/index.html"; // Webpage (host) to display Bin Levels
